			...
			<div id="2linea" style="clear: both; width: 308px; float:left; padding:0px; margin:0px; top:65px; position:absolute; display: block; overflow:hideen;">
				<table border="0px" style=" padding:0px; margin:0px; width: 308px;" >
					<tr>
                        ...
                        <td style="width: 50px; border-left-width: 1px; border-color: #000; border-style: solid;"><p style="padding:0px; margin:6px 0 0 0; float:left; text-align:center; font-size:16px;"><u><?php echo strtoupper($pic)?></u></p><p style="padding:0px; margin:0px; float:left; text-align:center; font-size: 10px;">PIC</p>
                        </td>
						<td style="width: 178px; height:27px; border-width: 1px; border-color: #000; border-style: solid;">
...
<?php
    if ($generate) {
        ...
        require_once($_SERVER['DOCUMENT_ROOT'].'/consultrada/bcode/vendor/autoload.php');
        try
        {
